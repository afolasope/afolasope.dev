...
export default function Profile() {
    return (
        <section className='flex flex-col gap-8 p-8 lg:h-screen lg:justify-between xl:py-20 xl:pl-20 xl:pr-0'>
            <section className='space-y-8'>
                ...
                <p className='text-primary leading-loose text-sm lg:max-w-[634px]'>
